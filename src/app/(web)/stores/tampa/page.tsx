...
export default function () {
  return (
    ...
    <iframe className="w-full min-h-[409px] mb-9" allow="clipboard-write" sandbox="allow-top-navigation allow-top-navigation-by-user-activation allow-downloads allow-scripts allow-same-origin allow-popups allow-modals allow-popups-to-escape-sandbox allow-forms" allowfullscreen="true" src="https://e.issuu.com/embed.html?d=qcsantamonicamenu&amp;u=qargocoffee"></iframe>
