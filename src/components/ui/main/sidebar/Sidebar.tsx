        ...
        <>
            ...
            >
                {items.map((item) => (
                    <div
                        key={item.slug}
                        className="p-3 md:p-5 backdrop-filter backdrop-blur-md bg-white/30 m-1"
                        onClick={() => {
                    ...
                    >
                        ...
                        {item.Items && item.Items.length > 0 ? (
                            <div
                                ...
                                <span className="text-focus-in text-lg md:text-xl text-lavazzaBlue font-medium">
                                    {item.title}
                                </span>
                                <Image
                            ...
                            <Link
                                href={`/${item.slug}`}
                                className="block text-focus-in text-lg md:text-xl text-lavazzaBlue font-medium"
                            ...
                            <div className="ml-6 mt-2">
                                {item.Items.map((subcategory) => (
                                    <Link
                                        ...
                                        className="block text-sm mt-2 md:text-lg tracking-widest text-lavazzaBlue text-focus-in"
                                        onClick={closeSideMenu}
                                    >
                                        {subcategory.title}
                                    </Link>
